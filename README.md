...
The notebooks define `data_prefix = 'data/'` near the imports because the large
...
`DR1_MWS_tutorial.ipynb` uses `mwsall_dr1_slim.fits`, a local slim all-row catalogue
